...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM1_MspPostInit 0 */
    ...
    PE13     ------> TIM1_CH3
    */
    GPIO_InitStruct.Pin = BUH1PWMN_Pin|BUH1PWM_Pin|BUH2PWMN_Pin|BUH2PWM_Pin;
  ...
  /* USER CODE END TIM2_MspPostInit 0 */
    ...
    PB11     ------> TIM2_CH4
    */
    GPIO_InitStruct.Pin = TEK2PWM2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM2;
    HAL_GPIO_Init(TEK2PWM2_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM12_MspPostInit 0 */
    ...
    PB14     ------> TIM12_CH1
    */
    GPIO_InitStruct.Pin = TEK1PWM2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF9_TIM12;
    HAL_GPIO_Init(TEK1PWM2_GPIO_Port, &GPIO_InitStruct);
